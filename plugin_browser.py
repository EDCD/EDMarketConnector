...
def report_plugin(plugin) -> None:  # FIXME: Update to live repo.
    """Open the Webbrowser to the new plugin issue report."""
    webbrowser.open(
        f"https://github.com/EDCD/EDMC_Plugin_Registry_Dev/issues/new?"
...
class PluginBrowserMixIn:
    ...
    def setup_browser_tab(self, notebook: nb.Notebook, row) -> None:
        ...
        HyperlinkLabel(
            ...
            url="https://github.com/EDCD/EDMC_Plugin_Registry_Dev",  # Fixme
            underline=True,
