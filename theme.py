...
class _Theme:
    ...
    def register(  # noqa: CCR001, C901
        self, widget: Union[tk.Widget, tk.BitmapImage]
    ) -> None:
    ...
    def button_bind(
        ...
        widget: tk.Widget,
        command: Callable,
        image: Optional[tk.BitmapImage] = None,
    ) -> None:
        ...
        if theme == self.THEME_DEFAULT:
            ...
            self.current = {
                ...
                "font": (
                    ...
                    and tk_font.Font(family="Euro Caps", size=10, weight=tk_font.NORMAL)
                    or "TkDefaultFont"
                ),
            }
    ...
    def _update_widget(  # noqa: CCR001, C901
        self, widget: Union[tk.Widget, tk.BitmapImage]
    ) -> None:
        if widget not in self.widgets:
        ...
        try:
            ...
            elif "cursor" in widget.keys() and str(widget["cursor"]) not in [
                "",
                "arrow",
            ]:
    ...
    def apply(self, root: tk.Tk) -> None:  # noqa: CCR001, C901
        ...
        if sys.platform == "darwin":
            ...
            if theme == self.THEME_TRANSPARENT:
                SetWindowLongW(
                    hwnd, GWL_EXSTYLE, WS_EX_APPWINDOW | WS_EX_LAYERED
                )  # Add to taskbar
